# Adapted from: https://github.com/SciCompMod/memilio/blob/inside-demonstrator-munich-fitting/pycode/examples/simulation/ABM%20Demonstrator/abm_demonstrator_munich.py
...
def run_abm_simulation(sim_num, kappa, init_e, damp_time, damp_lvl):
    ...
    sim.model.parameters = set_infection_parameters(parameters, kappa)
    ...
    sim.model.add_infection_rate_damping(
        abm.TimePoint(abm.days(damp_time).seconds), damp_lvl)
    ...
    assign_infection_states(sim.model, t0, init_e, 0.00005,
